...
4. **Pointer scanning mode:**
   - Whether to use **multi-threaded RTTI/pointer scanning**
   - **No (default)**: safer and more compatible, but slightly slower
   - **Yes**: faster on most machines, but if you run into issues finding pointers, switch this back to **No**
